...
use crate::arch::amd64::{gdt::{KERNEL_CODE_SELECTOR, KERNEL_DATA_SELECTOR, USER_CODE_SELECTOR, USER_DATA_SELECTOR}, memory::{misc::{pages_to_order, phys_to_virt}, pmm::pages_allocator::{PAllocFlags, alloc_pages_by_order}, vmm::{KernelFrameAllocator, PAGE_SIZE, create_new_pt4_from_kernel_pt4, kernel_pt}}, scheduler::{elf::ElfParsed, stack::{DEFAULT_KERNEL_STACK_SIZE, allocate_kernel_stack}, task::{Task, TaskId, TaskRegisters, TaskState}}};
...
pub fn make_user_task(bytes: &[u8]) -> Result<Task, &'static str> {
    ...
    Ok(Task {
        id: TaskId { index: 1337, generation: 0 },
        kernel_stack,
